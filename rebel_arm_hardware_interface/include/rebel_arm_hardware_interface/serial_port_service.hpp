...
namespace rebel_arm_hardware_interface
{
    class SerialPortService
    {
        ...
        void BindRebelArmFeedbackCallback(std::function<void(RebelArmFeedback)>);
        ...
        std::function<void(RebelArmFeedback)> rebelArmFeedbackCallback;

        RebelArmFeedback rebelArmFeedback {};
    };
}
